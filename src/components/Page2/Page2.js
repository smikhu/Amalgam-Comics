        ...
        <div className="css-grid">
            ...
            <div className="grid grid-item9">
                ...
                <div className="aliases bubble2 bubble-bottom-right">
                    ...
                    {props.characters?.biography?.aliases[3] ? <p>-{props.characters?.biography?.aliases[3]}</p> : null}
                    {props.characters?.biography?.aliases[4] ? <p>-{props.characters?.biography?.aliases[4]}</p> : null}
                    {props.characters?.biography?.aliases[5] ? <p>-{props.characters?.biography?.aliases[5]}</p> : null}
                </div>
            </div>
            <div className="grid grid-item10">
                <h3><span className="seven">10. APPEARANCE</span></h3>
                <div className="appearance">
                {props.characters?.appearance?.['eye-color'] ? <p>Eye Color - {props.characters?.appearance?.['eye-color']}</p> : null}
                {props.characters?.appearance?.['hair-color'] ? <p>Hair Color - {props.characters?.appearance?.['hair-color']}</p> : null}
                {props.characters?.appearance?.height[0] ? <p>Height - {props.characters?.appearance?.height[0]}</p> : null}
                {props.characters?.appearance?.weight[0] ? <p>Weight - {props.characters?.appearance?.weight[0]}</p> : null}
                </div>
            </div>
